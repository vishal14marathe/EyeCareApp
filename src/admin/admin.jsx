...
const Admin = ({ currentPath, navigate }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    heroDescription:
      "Experience the pinnacle of optical engineering paired with high-fashion aesthetics. Precision lenses met with avant-garde design.",
    aboutTitle: "Crafting the Future of Vision",
    aboutDescription1:
      "At Visionary Elite, we believe that eyewear is not just a medical necessity, but a statement of identity.",
    collectionsTitle: "The Collections",
    collectionsSubtitle: "Curated masterpieces from around the globe.",
    ...
    services: [
      {
        id: 1,
        title: "Advanced Eye Test",
        description:
          "Comprehensive diagnostics using state-of-the-art AI imaging technology.",
      },
      {
        id: 2,
        title: "Custom Lens Crafting",
        description:
          "Lenses tailored specifically to your prescription and lifestyle needs.",
      },
      {
        id: 3,
        title: "Style Consultation",
        description:
          "Personal styling to find the perfect frames that match your facial structure.",
      },
    ],
    virtualTryOnDescription:
      "Experience our proprietary AI-driven Virtual Try-On. Precisely mapped to your facial structure for a perfect virtual fit.",
    ...
    vtoFeature2Desc:
      "Simulates how light passes through your prescription lenses.",
    aboutDescription2:
      "Our team of world-class optometrists and master artisans work in harmony to ensure that every frame we deliver provides unparalleled clarity and unmatched style.",
    stat1Value: "10+",
        ...
        <div style={sidebarStyle}>
          ...
          <div
            style={{
              ...sidebarLink,
              backgroundColor:
                activeSection === "home" ? "#fff" : "transparent",
          ...
          <div
            style={{
              ...sidebarLink,
              backgroundColor:
                activeSection === "collections" ? "#fff" : "transparent",
          ...
          <div
            style={{
              ...sidebarLink,
              backgroundColor:
                activeSection === "virtual-try-on" ? "#fff" : "transparent",
          ...
          <div
            style={{
              ...sidebarLink,
              backgroundColor:
                activeSection === "services" ? "#fff" : "transparent",
          ...
          <div
            style={{
              ...sidebarLink,
              backgroundColor:
                activeSection === "about" ? "#fff" : "transparent",
        ...
        <div style={mainContentStyle}>
          ...
          <div style={contentArea}>
            ...
            <div style={cardStyle}>
              ...
              {error && (
                <p style={{ color: "#e51c24", marginBottom: "1rem" }}>
                  {error}
                </p>
              )}
                ...
                {activeSection === "collections" && (
                  <>
                      ...
                      {formData.collections &&
                        formData.collections.map((item) => (
                          ...
                          >
                            <div>
                              <div
                                style={{ fontWeight: "600", color: "#202223" }}
                              >
                                {item.name}
                              </div>
                              <div
                            ...
                            <div style={{ display: "flex", gap: "0.5rem" }}>
                              ...
                              <button
                                ...
                                onClick={async () => {
                                  ...
                                  const updated = formData.collections.filter(
                                    (c) => c.id !== item.id,
                                  );
                                  setFormData({
                                    ...formData,
                    ...
                    >
                      <input
                        type="text"
                        placeholder="Collection Name (e.g. MELLER)"
                        value={newCol.name}
                        onChange={(e) =>
                      ...
                      <input
                        type="text"
                        placeholder="Description (e.g. Made in Spain)"
                        value={newCol.desc}
                        onChange={(e) =>
                          setNewCol({ ...newCol, desc: e.target.value })
                        }
                        style={inputStyle}
                      />
                      <input
                        ...
                        value={newCol.img}
                        onChange={(e) =>
                          setNewCol({ ...newCol, img: e.target.value })
                        }
                        style={inputStyle}
                      />
                      <div
                ...
                {activeSection === "virtual-try-on" && (
                  <>
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      >
                        Virtual Try-On Title
                      </label>
                      <input
                        type="text"
                        name="virtualTryOnTitle"
                        value={formData.virtualTryOnTitle}
                        onChange={handleInputChange}
                        style={inputStyle}
                      />
                    </div>
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      <textarea
                        name="virtualTryOnDescription"
                        value={formData.virtualTryOnDescription}
                        onChange={handleInputChange}
                    ...
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      <input
                        type="text"
                        name="vtoFeature1Title"
                        value={formData.vtoFeature1Title}
                        onChange={handleInputChange}
                        style={inputStyle}
                      />
                    </div>
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      <input
                        type="text"
                        name="vtoFeature1Desc"
                        value={formData.vtoFeature1Desc}
                        onChange={handleInputChange}
                        style={inputStyle}
                      />
                    </div>
                    ...
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      <input
                        type="text"
                        name="vtoFeature2Title"
                        value={formData.vtoFeature2Title}
                        onChange={handleInputChange}
                        style={inputStyle}
                      />
                    </div>
                    <div style={{ marginBottom: "1.5rem" }}>
                      ...
                      <input
                        type="text"
                        name="vtoFeature2Desc"
                        value={formData.vtoFeature2Desc}
                        onChange={handleInputChange}
                        style={inputStyle}
                      />
                    </div>
                ...
                {activeSection === "services" && (
                  <>
                    ...
                    >
                      <input
                        type="text"
                        placeholder="Service Title (e.g. Advanced Eye Test)"
